...
public class PlayerSummary {
  ...
  public void set(String name, int turns, int deckSize, boolean stashOnDeck, int handSize, int stashesInHand,
                   int numCards, int pt, int vt, int dt, int gct, boolean minusOneCoinTokenOn,
                   boolean minusOneCardTokenOn, JourneyTokenState journeyToken, boolean highlight, boolean showColor,
                   int color) {
    this.name = name;
    this.turns = turns;
