...
public class GameStatus implements Serializable {
  ...
  public GameStatus setPossessed(boolean b) {
    isPossessed = b;
    return this;
  }

  public GameStatus setTurnCounts(int[] is) {
    turnCounts = is;
    return this;
  }

  public GameStatus setRealNames(String[] is) {
    realNames = is;
    return this;
  }
  ...
  public GameStatus setPlayedCards(int[] is) {
    playedCards = is;
    return this;
  }

  public GameStatus setTavern(int[] is) {
    myTavern = is;
    return this;
  }
  ...
  public GameStatus setDebtTokens(int[] is) {
    debtTokens = is;
    return this;
  }

  public GameStatus setGuildsCoinTokens(int[] is) {
    guildsCoinTokens = is;
    return this;
  }

  public GameStatus setJourneyToken(JourneyTokenState[] is) {
    journeyTokens = is;
    return this;
  }

  public GameStatus setMinusOneCoinToken(boolean[] is) {
    minusOneCoinTokenOn = is;
    return this;
  }

  public GameStatus setMinusOneCardToken(boolean[] is) {
    minusOneCardTokenOn = is;
    return this;
  }

  public GameStatus setHauntedWoodsAttacks(boolean i) {
    hauntedWoodsAttacks = i;
    return this;
  }

  public GameStatus setEnchantressAttacks(boolean i) {
    enchantressAttacks = i;
    return this;
  }
  ...
  public GameStatus setTrash(int[] is) {
    trashPile = is;
    return this;
  }

  public GameStatus setBlackMarket(int[] is) {
    blackMarketPile = is;
    return this;
  }
