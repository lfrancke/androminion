...
public class UI extends JFrame implements GameEventListener {
  ...
  public void gameEvent(GameEvent event) {
    ...
    if ((event.getType() == GameEvent.EventType.PlayingCard
         || event.getType() == GameEvent.EventType.PlayingDurationAction
         || event.getType() == GameEvent.EventType.CallingCard)
    ...
    if (event.getType() == GameEvent.EventType.CardRemovedFromHand
        && event.getPlayer() == Game.players[Game.playersTurn]) {
