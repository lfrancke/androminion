...
public abstract class QuickPlayPlayer extends BasePlayer {
  ...
  public boolean shouldAutoPlay_remodel_cardToObtain(MoveContext context, int maxCost, int maxDebtCost,
                                                      boolean potion) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_courtier_cardToReveal(MoveContext context) {
    return true;
  }

  public boolean shouldAutoPlay_courtier_chooseOptions(MoveContext context, CourtierOption[] options,
                                                        int numberOfChoices) {
    return false;
  }

  public boolean shouldAutoPlay_diplomat_cardsToDiscard(MoveContext context) {
    return true;
  }

  public boolean shouldAutoPlay_lurker_selectChoice(MoveContext context, LurkerOption[] options) {
    return false;
  }

  public boolean shouldAutoPlay_lurker_cardToTrash(MoveContext context) {
    return false;
  }

  public boolean shouldAutoPlay_lurker_cardToGainFromTrash(MoveContext context) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_saboteur_cardToObtain(MoveContext context, int maxCost, int maxDebtCost,
                                                       boolean potion) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_replace_cardToObtain(MoveContext context, int maxCost, int maxDebtCost,
                                                      boolean potion) {
    return false;
  }

  public boolean shouldAutoPlay_mill_cardsToDiscard(MoveContext context) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_mint_treasureToMint(MoveContext context) {
    ...
    for (Card c : getHand()) {
      if (c.is(Type.Treasure, this) && Cards.isSupplyCard(c) && !(c.equals(Cards.copper) || c.equals(Cards.silver)
                                                                  || c.equals(Cards.gold) || c.equals(
        Cards.platinum))) {
        return false;
      }
    }
  ...
  public boolean shouldAutoPlay_royalSealTravellingFair_shouldPutCardOnDeck(MoveContext context, Card responsible,
                                                                             Card card) {
    return true;
  }
  ...
  public boolean shouldAutoPlay_haggler_cardToObtain(MoveContext context, int maxCost, int maxDebtCost,
                                                      boolean potion) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_stash_chooseDeckPosition(MoveContext context, int deckSize, int numStashes,
                                                          int cardsToDraw) {
  ...
  public boolean shouldAutoPlay_call_whenActionResolveCardToCall(MoveContext context, Card resolvedCard,
                                                                  Card[] possibleCards) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_transmogrify_cardToObtain(MoveContext context, int maxCost, int maxDebtCost,
                                                           boolean potion) {
    return false;
  }
  ...
  public boolean shouldAutoPlay_smallCastle__shouldTrashSmallCastlePlayed(MoveContext context, Card responsible) {
    return false;
  }

  public boolean shouldAutoPlay_smallCastle_castleToTrash(MoveContext context) {
    return false;
  }

  public boolean shouldAutoPlay_sprawlingCastle_chooseOption(MoveContext context) {
    return false;
  }
  ...
  public boolean shoudlAutoPlay_payoffDebt(MoveContext context) {
    ...
    if (context.player.getTavern().contains(Cards.wineMerchant) && context.getCoins() >= 2
        && context.getCoins() - getDebtTokenCount() < 2) {
      return false;
    }
