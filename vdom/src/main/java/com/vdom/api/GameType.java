...
public enum GameType {
  ...
  GrandScheme("Grand Scheme", Expansion.Base2E,
               Expansion.Intrigue2E),
  Deconstruction2("Deconstruction",
                   Expansion.Base2E,
                   Expansion.Intrigue2E),

  // Seaside
  HighSeas("High Seas (Sea)", Expansion.Seaside),
  BuriedTreasure("Buried Treasure (Sea)",
                  Expansion.Seaside),
  Shipwrecks("Shipwrecks (Sea)",
              Expansion.Seaside),
  // Base and Seaside
  ReachForTomorrow("Reach for Tomorrow", Expansion.Seaside, Expansion.Base),
  Repetition("Repetition", Expansion.Seaside,
              Expansion.Base),
  ...
  PotionMixers("Potion Mixers", Expansion.Alchemy,
                Expansion.Base),
  ChemistryLesson("Chemistry Lesson",
                   Expansion.Alchemy,
                   Expansion.Base),
  // Base 2E and Alchemy
  ForbiddenArts2("Forbidden Arts", Expansion.Alchemy, Expansion.Base2E),
  PotionMixers2("Potion Mixers",
                 Expansion.Alchemy,
                 Expansion.Base2E),
  ChemistryLesson2("Chemistry Lesson",
                    Expansion.Alchemy,
                    Expansion.Base2E),
  // Intrigue and Alchemy
  Servants("Servants", Expansion.Alchemy, Expansion.Intrigue),
  SecretResearch("Secret Research", Expansion.Alchemy,
                  Expansion.Intrigue),
  PoolsToolsAndFools("Pools, Tools, and Fools",
                      Expansion.Alchemy,
                      Expansion.Intrigue),
  // Intrigue 2E and Alchemy
  Servants2("Servants", Expansion.Alchemy, Expansion.Intrigue2E),
  SecretResearch2("Secret Research", Expansion.Alchemy,
                   Expansion.Intrigue2E),
  PoolsToolsAndFools2("Pools, Tools, and Fools",
                       Expansion.Alchemy,
                       Expansion.Intrigue2E),

  // Prosperity
  Beginners("Beginners", Expansion.Prosperity),
  FriendlyInteractive("Friendly Interactive",
                       Expansion.Prosperity),
  BigActions("Big Actions",
              Expansion.Prosperity),
  // Base and Prosperity
  BiggestMoney("Biggest Money", Expansion.Prosperity, Expansion.Base),
  TheKingsArmy("The King's Army",
                Expansion.Prosperity,
                Expansion.Base),
  TheGoodLife("The Good Life",
               Expansion.Prosperity,
               Expansion.Base),
  // Base 2E and Prosperity
  BiggestMoney2("Biggest Money", Expansion.Prosperity, Expansion.Base2E),
  TheKingsArmy2("The King's Army",
                 Expansion.Prosperity,
                 Expansion.Base2E),
  TheGoodLife2("The Good Life",
                Expansion.Prosperity,
                Expansion.Base2E),
  // Intrigue and Prosperity
  PathsToVictory("Paths to Victory", Expansion.Prosperity,
                  Expansion.Intrigue),
  AllAlongTheWatchtower("All Along the Watchtower", Expansion.Prosperity,
                         Expansion.Intrigue),
  ...
  PathsToVictory2("Paths to Victory", Expansion.Prosperity,
                   Expansion.Intrigue2E),
  AllAlongTheWatchtower2("All Along the Watchtower", Expansion.Prosperity,
                          Expansion.Intrigue2E),
  LuckySeven2("Lucky Seven",
               Expansion.Prosperity,
               Expansion.Intrigue2E),
  ...
  BadOmens("Bad Omens",
            ...
            Expansion.Base),
  TheJestersWorkshop("The Jester's Workshop",
                      Expansion.Cornucopia,
                      Expansion.Base),
  // Intrigue and Cornucopia
  LastLaughs("Last Laughs", Expansion.Cornucopia, Expansion.Intrigue),
  TheSpiceOfLife("The Spice of Life",
                  Expansion.Cornucopia,
                  Expansion.Intrigue),
  SmallVictories("Small Victories",
                  Expansion.Cornucopia,
                  Expansion.Intrigue),
  ...
  CleanLiving("Clean Living", Expansion.Guilds,
               Expansion.Base),
  GildingTheLily("Gilding the Lily",
                  Expansion.Guilds,
                  Expansion.Base),
  // Guilds and Base 2E
  ArtsAndCrafts2("Arts and Crafts", Expansion.Guilds, Expansion.Base2E),
  CleanLiving2("Clean Living", Expansion.Guilds,
                Expansion.Base2E),
  GildingTheLily2("Gilding the Lily",
                   Expansion.Guilds,
                   Expansion.Base2E),
  // Guilds and Intrigue
  ...
  TricksOfTheTrade2("Tricks of the Trade",
                     Expansion.Guilds,
                     Expansion.Intrigue2E),
  DecisionsDecisions2("Decisions, Decisions",
                       Expansion.Guilds,
                       Expansion.Intrigue2E),
  ...
  TheHerosReturn("The Hero's Return", Expansion.Adventures,
                  Expansion.Cornucopia),
  SeacraftAndWitchcraft("Seacraft and Witchcraft", Expansion.Adventures,
                         Expansion.Cornucopia),
  ...
  BuddySystem2("Buddy System",
                Expansion.Empires,
                Expansion.Intrigue2E),
  // Empires and Seaside
  BoxedIn("Boxed In", Expansion.Empires, Expansion.Seaside),
  KingOfTheSea("King of the Sea", Expansion.Empires,
                Expansion.Seaside),
  // Empires and Alchemy
  ...
  GildedGates("Gilded Gates", Expansion.Empires,
               Expansion.Prosperity),
  ...
  HinterExpansion("Expansion", Expansion.Empires,
                   Expansion.Hinterlands),
  // Empires and Dark Ages
  TombOfTheRatKing("Tomb of the Rat King", Expansion.Empires,
                    Expansion.DarkAges),
  TriumphOfTheBanditKing("Triumph of the Bandit King", Expansion.Empires,
                          Expansion.DarkAges),
  TheSquiresRitual("The Squire's Ritual",
                    Expansion.Empires,
                    Expansion.DarkAges),
  // Empires and Guilds
  ...
  NoMoneyNoProblems("No Money No Problems",
                     Expansion.Empires,
                     Expansion.Adventures),
