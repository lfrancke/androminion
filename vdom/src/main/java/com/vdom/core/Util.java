...
public class Util {
  ...
  static boolean isDefendedFromAttack(Game game, Player player, Card responsible) {
    ...
    while ((reactionCard = player.controlPlayer.getAttackReaction(context, responsible, defended, reactionCardAbility))
           != null) {
  ...
  private static boolean doSecretChamber(MoveContext context, Game game, Player player, Card responsible,
                                          Card reactionCard) {
    ...
    if (found) {
      ...
      if (!player.hand.isEmpty()) {
        ...
        if (bad) {
          playerError(player, "Secret Chamber cards to put on deck error, putting first two cards in hand back.",
            false);
  ...
  private static boolean doHorseTraders(MoveContext context, Game game, Player player, Card responsible,
                                         Card reactionCard) {
  ...
  private static boolean doCaravanGuard(MoveContext context, Game game, Player player, Card responsible,
                                         Card reactionCard) {
  ...
  private static boolean doDiplomat(MoveContext context, Game game, Player player, Card responsible,
                                     Card reactionCard) {
    boolean found = false;
    for (Card card : player.hand) {
      if (card.equals(reactionCard)) {
