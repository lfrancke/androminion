...
public class StartGameFragment extends SherlockFragment implements OnClickListener, OnItemSelectedListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    completeSets
      .put(Expansion.Prosperity, mRandomProsperity = (ToggleButton) mView.findViewById(R.id.toggleButtonProsperity));
    completeSets
      .put(Expansion.Cornucopia, mRandomCornucopia = (ToggleButton) mView.findViewById(R.id.toggleButtonCornucopia));
    completeSets
      .put(Expansion.Hinterlands, mRandomHinterlands = (ToggleButton) mView.findViewById(R.id.toggleButtonHinterlands));
    completeSets
      .put(Expansion.DarkAges, mRandomDarkAges = (ToggleButton) mView.findViewById(R.id.toggleButtonDarkAges));
    completeSets.put(Expansion.Guilds, mRandomGuilds = (ToggleButton) mView.findViewById(R.id.toggleButtonGuilds));
    completeSets
      .put(Expansion.Adventures, mRandomAdventures = (ToggleButton) mView.findViewById(R.id.toggleButtonAdventures));
    ...
    String defaultGameType = getBaseEdition() == Expansion.Base ? "FirstGame" : "FirstGame2";
    GameType gameType;
    try {
  ...
  private void updateVisibility() {
    ...
    int includeCardsVisibility =
      mGameType == TypeOptions.PRESET || mGameType == TypeOptions.RANDOM ? View.VISIBLE : View.GONE;
